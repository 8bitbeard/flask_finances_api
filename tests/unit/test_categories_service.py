...
def test_create_categories_service_method(mock_get_sqlalchemy, mock_user_object, mock_s_category_object, mocker):
...
def test_index_categories_service_method(mock_get_sqlalchemy, mock_user_object, mock_s_category_object, mocker):
